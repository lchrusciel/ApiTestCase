...
{
    const DEFAULT_EXPECTED_RESPONSE_SOURCE = '../src/AppBundle/Tests/Responses';
    const DEFAULT_MOCKED_RESPONSE_SOURCE = '../src/AppBundle/Tests/Fixtures';
    ...
    {
        $responseSource = (isset($_SERVER['MOCKED_RESPONSE_DIR'])) ? $_SERVER['MOCKED_RESPONSE_DIR'] : self::DEFAULT_EXPECTED_RESPONSE_SOURCE;
    ...
    {
        $responseSource = (isset($_SERVER['EXPECTED_RESPONSE_DIR'])) ? $_SERVER['EXPECTED_RESPONSE_DIR'] : self::DEFAULT_EXPECTED_RESPONSE_SOURCE;
